...
public struct CollectionChanges<ChangeElement> {
  ...
  ///
  /// - Parameter changes: a collection of `CollectionChanges.Change`
  ...
  /// `changes(from:)` method declared on the `BidirectionalCollection`
  /// protocol.
  ///
  ...
  public init?<Changes: Collection>(
    ...
    guard CollectionChanges<ChangeElement>._validateChanges(changes) else {
      return nil
    }
  ...
  /// `CollectionChanges.init?(_:)` should be used instead.
  ///
  ...
  public func inverse() -> Self {
    return CollectionChanges(_validatedChanges: self.map { c in
      switch c {
...
/// A CollectionChanges is itself a Collection.
///
...
/// }
/// ```
extension CollectionChanges: Collection {
...
extension CollectionChanges.Index: Equatable {
  @inlinable
  public static func == (
    lhs: CollectionChanges.Index,
...
extension CollectionChanges.Index: Comparable {
  @inlinable
  public static func < (
    lhs: CollectionChanges.Index,
    rhs: CollectionChanges.Index
...
extension CollectionChanges.Index: Hashable {
  @inlinable
...
extension CollectionChanges.Change: Equatable where ChangeElement: Equatable {}

extension CollectionChanges: Equatable where ChangeElement: Equatable {}

extension CollectionChanges.Change: Hashable where ChangeElement: Hashable {}

extension CollectionChanges: Hashable where ChangeElement: Hashable {}

extension CollectionChanges where ChangeElement: Hashable {
  ...
  public func inferringMoves() -> CollectionChanges<ChangeElement> {
    ...
    return CollectionChanges(_validatedChanges: map({ (change: Change) -> Change in
      switch change {
...
extension CollectionChanges.Change: Codable where ChangeElement: Codable {
...
extension CollectionChanges: Codable where ChangeElement: Codable {}
