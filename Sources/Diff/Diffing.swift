...
extension RangeReplaceableCollection {
  ...
  public func applying(_ difference: CollectionChanges<Element>) -> Self? {
...
extension BidirectionalCollection {
  ...
  public func changes<C: BidirectionalCollection>(
    from other: C,
    by areEquivalent: (C.Element, Element) -> Bool
  ) -> CollectionChanges<Element>
...
extension BidirectionalCollection where Element: Equatable {
  ...
  public func changes<C: BidirectionalCollection>(
    from other: C
  ) -> CollectionChanges<Element> where C.Element == Self.Element {
    return changes(from: other, by: ==)
  }
}
...
C.Element == D.Element
{
  ...
  func _formChanges(
    ...
    using trace: [_V]
  ) -> [CollectionChanges<C.Element>.Change] {
    var changes = [CollectionChanges<C.Element>.Change]()
  ...
  return _withContiguousStorage(for: old) { a in
    return _withContiguousStorage(for: new) { b in
      return CollectionChanges(_formChanges(from: a, to: b, using:_descent(from: a, to: b)))!
    }
  }
}
